...
class Preprocessor_occluded(object):
    ...
    def get_params(self, img0, scale=(0.01, 0.03), ratio=(0.3, 3.3)):  # Ëæ»úmy2
        img = img0.copy()
    ...
    def _get_single_item(self, index):
        ...
        if self.transform is not None:
            if self.train:
                ...
                return torch.cat([img, img_l, img_r, img_d, img_u, img_l_, img_r_, img_d_, img_u_],
                                 0), fname, pid, camid, index, size
