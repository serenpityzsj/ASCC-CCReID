...
class LTCC(BaseImageDataset):
    ...
    'python main.py --gpu_devices 0 --dataset ltcc --dataset_root /home/user3/ZSJ/data --dataset_filename LTCC-reID  --resume /home/user3/ZSJ/CSSC-CCReID/ltcc_save_1/best_rank1_model.pth --save_dir ltcc_eva --evaluate'
    """
    def __init__(self, dataset_root='/home/user3/ZSJ/CSSC-CCReID/dataset/data', dataset_filename='LTCC-reID', verbose=True, **kwargs):
