...
python main.py --gpu_devices 0 --dataset prcc --dataset_root dataset/data --dataset_filename prcc --save_dir prcc_save_20 --save_checkpoint
python main.py --gpu_devices 1 --dataset prcc --dataset_root dataset/data --dataset_filename prcc --save_dir prcc_save_13 --save_checkpoint

python main.py --gpu_devices 0 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_41 --save_checkpoint
python main.py --gpu_devices 0 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_42 --save_checkpoint
python main.py --gpu_devices 0 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_43 --save_checkpoint

python main.py --gpu_devices 1 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_64 --save_checkpoint

python main.py --gpu_devices 0 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_63 --save_checkpoint

python main.py --gpu_devices 2 --dataset ltcc --dataset_root dataset/data --dataset_filename LTCC-reID --save_dir ltcc_save_62 --save_checkpoint

python main.py --gpu_devices 2 --dataset celeb --dataset_root dataset/data --dataset_filename Celeb-reID --num_instances 4 --save_dir cele_save_11 --save_checkpoint
"""
...
from model.cssc import CSSC
import train_cssc, test_cc, test
...
def main():
    ...
    model = CSSC(last_stride=1, pretrain=True, num_classes=num_classes)
    ...
    # metric_criterion = SN_LOSS(alpha=30, margin=1, k=16, weight=1.0)

    optimizer = torch.optim.Adam(params=[{'params': model.parameters(), 'initial_lr': args.lr}],
    ...
    for epoch in range(start_epoch, args.max_epoch):
        ...
        train_cssc.train(args, epoch + 1, train_loader, model, optimizer, scheduler,
                         class_criterion, metric_criterion, use_gpu)
