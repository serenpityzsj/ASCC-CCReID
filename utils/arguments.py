...
def get_args():
    ...
    parser.add_argument('--dataset_root', type=str, default='/home/user3/ZSJ/CSSC-CCReID/dataset/data', help="root path to data directory")
    ...
    parser.add_argument('--use_occlusion', action='store_true',
                        help='use occlusion augmentation for cloth-changing ReID')
